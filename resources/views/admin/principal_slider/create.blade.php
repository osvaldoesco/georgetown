        ...
        <div class="admin-card">
          <form action="{{ route('principal_slider.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea rows="3" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" placeholder="Descripción" name="description">{{old('description')}}</textarea>
            ...
            <div class="custom-file">
              <input type="file" class="custom-file-input {{ $errors->has('image') ? 'is-invalid' : '' }}" name="image" id="custom-file-input" lang="es" onchange="putImage()">
            ...
            <br />
            <div class="form-group">
              <img src="#" alt="image2" class="preview-image-form d-none"  id="target2"/>
            </div>
            <div class="custom-file">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" name="link" placeholder="Enlace" value="{{old('link')}}">
              @if ($errors->has('link'))
                <span class="invalid-feedback" role="alert">
